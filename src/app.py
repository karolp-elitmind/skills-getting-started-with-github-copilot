...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim laps, train for meets, and learn aquatic skills",
    ...
    "Drama Club": {
        ...
        "max_participants": 25,
        "participants": ["jack@mergington.edu", "maria@mergington.edu"]
    },
    "Robotics Club": {
        "description": "Build and program robots for local and regional competitions",
        "schedule": "Tuesdays, 4:00 PM - 6:00 PM",
        "max_participants": 16,
        "participants": ["logan@mergington.edu", "claire@mergington.edu"]
    },
    "Debate Team": {
